...
class Config_US30K:
    ...
    data_path = "../../dataset/ShadowSAM/"
    save_path = "./checkpoints/ShadowSAM/"
    result_path = "./result/ShadowSAM/"
    tensorboard_path = "./tensorboard/ShadowSAM/"
...
class Config_SBU:
    data_path = "../../dataset/ShadowSAM/"
    data_subpath = "../../dataset/ShadowSAM/ThyroidNodule-SBU/"
    save_path = "./checkpoints/SBU/"
    result_path = "./result/SBU/"
    tensorboard_path = "./tensorboard/SBU/"
    load_path = save_path + "/xxx.pth"
    save_path_code = "_"
    ...
    train_split = "train-ThyroidNodule-SBU"  # the file name of training set
    val_split = "val-ThyroidNodule-SBU"     # the file name of testing set
    test_split = "test-ThyroidNodule-SBU"     # the file name of testing set
    crop = None                  # the cropped image size
    eval_freq = 1                # the frequency of evaluate the model
    save_freq = 2000               # the frequency of saving the model
    device = "cuda"              # training device, cpu or cuda
...
class Config_BUSI:
    ...
    data_path = "../../dataset/ShadowSAM/"
    data_subpath = "../../dataset/ShadowSAM/Breast-BUSI/"
...
class Config_CAMUS:
    # This dataset is for breast cancer segmentation
    data_path = "../../dataset/ShadowSAM/"  #
    data_subpath = "../../dataset/ShadowSAM/Echocardiography-CAMUS/"
